...
from auto_testing.models import cnn, cnn_ad, core, rnn, gp, torch_rnn
...
def get_results(action_type, model_type, adaptation, file_name):
    ...
    fh = logging.FileHandler('exp_' + file_name + '_type_{}_{}_adapt_{}_fixed_seed.log'.format(action_type,
                                                                                               model_type,
                                                                                               adaptation))
...
def get_results_inter_subjects(action_type, model_type, adaptation, file_name):
    ...
    fh = logging.FileHandler('exp_inter_sub_' + file_name + '_type_{}_{}_adapt_{}_fixed_seed.log'.format(action_type,
                                                                                                         model_type,
                                                                                                         adaptation))
    fh.setLevel(logging.INFO)
...
def main(args):
    ...
    get_results_inter_subjects(action_type='1', model_type='rnn', adaptation=True, file_name='')
    get_results(action_type='1', model_type='rnn', adaptation=False, file_name='')
    get_results_inter_subjects(action_type='1', model_type='rnn', adaptation=False, file_name='')
    get_results(action_type='1', model_type='rnn', adaptation=True, file_name='')
